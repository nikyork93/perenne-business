 ...
 *
 * APPLE MAIL FIX: We wrap everything inside <body> with a 100%-width
 * table that has the dark background, AND we set body bgcolor + style
 * background-color directly. This eliminates the white margin Apple Mail
 * adds when the document body has a default white background.
 */
